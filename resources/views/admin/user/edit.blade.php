            ...
            <form class="row g-3" method="POST" action="{{ route('user.update', $user->id) }}">
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        <button type="submit" class="btn btn-grd-primary px-4" class="text-white">Edit</button>
                        <button type="submit" class="btn btn-grd-success px-4"><a href="{{route('user.index')}}" class="text-white">Back</a></button>
                    </div>
                </div>
            </form>
        </div>
