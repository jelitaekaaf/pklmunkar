              ...
              <div class="form-body mt-4">
                <form class="row g-3" method="post" action="{{route('register')}}">
                  ...
                  <div class="col-12">
                    ...
                    <input type="name" name="name" class="form-control @error('name') is-invalid @enderror" id="inputUsername" placeholder="Nama">
                    @error('name')
                  ...
                  <div class="col-12">
                    ...
                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="inputEmailAddress" placeholder="example@admin.com">
                    @error('email')
                      <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }} </strong>
                    @enderror
